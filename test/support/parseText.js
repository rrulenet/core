import { EN_LOCALE } from '../../dist/text.mjs';
...
class Weekday {
  ...
  toString() {
    ...
    const token = tokens[this.weekday];
...
const UNIT_FREQUENCIES = new Map([
  ['day', Frequency.DAILY],
...
function parseMonthlyOrYearlyPosition(text) {
...
function parseLeadingMonthList(text) {
...
function parseEveryClause(text) {
